...
/*Correlation comment - Do not change!  Original value='133532.029404617ziziffDpHzcftVcVVpDccfHf' Name ='userSession' Type ='ResponseBased'*/
	...
	lr_end_transaction("UC03_ViewItinerary", LR_AUTO);
